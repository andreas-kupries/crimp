...
#define crimp_m(image) ((image)->meta)
#define crimp_c(image) ((image)->itype->channels)

/* Rework image_type.[ch] for direct access via enum/defines */
#define crimp_type_hsv       crimp_imagetype_find ("crimp::image::hsv")
#define crimp_type_rgba      crimp_imagetype_find ("crimp::image::rgba")
#define crimp_type_rgb       crimp_imagetype_find ("crimp::image::rgb")
#define crimp_type_grey8     crimp_imagetype_find ("crimp::image::grey8")
#define crimp_type_grey16    crimp_imagetype_find ("crimp::image::grey16")
#define crimp_type_grey32    crimp_imagetype_find ("crimp::image::grey32")
#define crimp_type_float     crimp_imagetype_find ("crimp::image::float")
#define crimp_type_double    crimp_imagetype_find ("crimp::image::double")
#define crimp_type_fpcomplex crimp_imagetype_find ("crimp::image::fpcomplex")
...
#define crimp_new_hsv(w,h)       (crimp_new (crimp_type_hsv,       (w), (h)))
#define crimp_new_rgba(w,h)      (crimp_new (crimp_type_rgba,      (w), (h)))
#define crimp_new_rgb(w,h)       (crimp_new (crimp_type_rgb,       (w), (h)))
#define crimp_new_grey8(w,h)     (crimp_new (crimp_type_grey8,     (w), (h)))
#define crimp_new_grey16(w,h)    (crimp_new (crimp_type_grey16,    (w), (h)))
#define crimp_new_grey32(w,h)    (crimp_new (crimp_type_grey32,    (w), (h)))
#define crimp_new_float(w,h)     (crimp_new (crimp_type_float,     (w), (h)))
#define crimp_new_double(w,h)    (crimp_new (crimp_type_double,    (w), (h)))
#define crimp_new_fpcomplex(w,h) (crimp_new (crimp_type_fpcomplex, (w), (h)))

#define crimp_new_like(image)           (crimp_newm_at ((image)->itype, crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_like_transpose(image) (crimp_newm_at ((image)->itype, crimp_x(image), crimp_y(image), crimp_h(image), crimp_w(image), crimp_m(image)))

#define crimp_new_hsv_at(x,y,w,h)       (crimp_new_at (crimp_type_hsv,       (x), (y), (w), (h)))
#define crimp_new_rgba_at(x,y,w,h)      (crimp_new_at (crimp_type_rgba,      (x), (y), (w), (h)))
#define crimp_new_rgb_at(x,y,w,h)       (crimp_new_at (crimp_type_rgb,       (x), (y), (w), (h)))
#define crimp_new_grey8_at(x,y,w,h)     (crimp_new_at (crimp_type_grey8,     (x), (y), (w), (h)))
#define crimp_new_grey16_at(x,y,w,h)    (crimp_new_at (crimp_type_grey16,    (x), (y), (w), (h)))
#define crimp_new_grey32_at(x,y,w,h)    (crimp_new_at (crimp_type_grey32,    (x), (y), (w), (h)))
#define crimp_new_float_at(x,y,w,h)     (crimp_new_at (crimp_type_float,     (x), (y), (w), (h)))
#define crimp_new_double_at(x,y,w,h)    (crimp_new_at (crimp_type_double,    (x), (y), (w), (h)))
#define crimp_new_fpcomplex_at(x,y,w,h) (crimp_new_at (crimp_type_fpcomplex, (x), (y), (w), (h)))

#define crimp_new_hsv_like(image)       (crimp_newm_at (crimp_type_hsv,       crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_rgba_like(image)      (crimp_newm_at (crimp_type_rgba,      crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_rgb_like(image)       (crimp_newm_at (crimp_type_rgb,       crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_grey8_like(image)     (crimp_newm_at (crimp_type_grey8,     crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_grey16_like(image)    (crimp_newm_at (crimp_type_grey16,    crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_grey32_like(image)    (crimp_newm_at (crimp_type_grey32,    crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_float_like(image)     (crimp_newm_at (crimp_type_float,     crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_double_like(image)    (crimp_newm_at (crimp_type_double,    crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
#define crimp_new_fpcomplex_like(image) (crimp_newm_at (crimp_type_fpcomplex, crimp_x(image), crimp_y(image), crimp_w(image), crimp_h(image), crimp_m(image)))
